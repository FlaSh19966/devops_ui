    ...
    <div class="container-fluid">
      <div class="card dash-card">
        <div class="card-header d-block d-sm-flex flex-wrap justify-content-between">
          <h4 class="mb-sm-0">{{tlt('Whatsapp Campaign')}}</h4>
          <div class="card-act d-flex flex-wrap">
            <input
              class="form-control search-bar"
              id="search_bar_id"
              :placeholder="tlt('Search campaign here')"
              ...
              <div style="border: 1px solid #dbe2e8">
                <div class="col-sm-12">
                  <div style="color: #414141" class="d-flex">
                    <h5 class="pt-2">{{tlt('Campaign Details')}}</h5>
                    <span
                ...
                <div class="col-sm-12" style="margin-bottom: 1rem">
                  ...
                  <div v-else>
                    ...
                    <span
                      ...
                      style="color: red"
                      >{{tlt('A Campaign with this name already exists.')}}</span
                    >
                  </div>
                </div>
                <div class="col-sm-12" style="margin-bottom: 1rem">
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="form-group">
              <h5 class="heading">{{tlt('Campaign Name')}}</h5>
              <div class="ml-3">
                <input
            ...
            <div class="form-group">
              <h5 class="heading">{{tlt('Select from Pre-approved Templates')}}</h5>
              <div class="container">
                <div class="row">
                  <div
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="form-group">
              <h5>
                <p class="mt-2 mb-0" style="color: #414141">{{tlt('Campaign Name')}}</p>
              </h5>
            ...
            <div class="form-group m-0">
              <div class="d-flex">
                <h5>
                  <p class="mb-0" style="color: #414141">{{tlt('Send Campaign to')}}</p>
                </h5>
              </div>
            </div>
            ...
            <div class="form-group">
              <h5>
                <p class="mt-2 mb-0" style="color: #414141">{{tlt('Campaign Preview')}}</p>
              </h5>
              <div v-if="Boolean(preview_template_data)">
  ...
  methods: {
    ...
    save_custome_template(){
      ...
      //     console.log("entered in close")
          ...
          // let btn =document.getElementById('save_btn_custom');
          //     btn.setAttribute("data-dismiss" , "modal");
          //     // $(`#${id}`).attr("data-dismiss","modal"); 
    ...
    //Read the contents of Image File.
      ...
      reader.readAsDataURL(vm.imgFile[0]);
      reader.onload = function (e) {
        ...
        image.onload = function () {
          ...
          if( width > 330 || height > 173){
            swal({
              title: "Oops",
              text: "Please upload image in given dimensions (330 x 170px)",
              type: "error",
              showCancelButton: false
            })
            vm.approved = false
            ...
            // console.log(("APPROVED----") , this.save_image_func)
            // this.save_image_func(template_details);
          ...
          if(vm.approved === true){        
            ...
            axios
              .post(
                ...
                {
                  headers: {
                    Authorization: `Bearer ${vm.$session.get("at")}`,
                  },
                }
              )
              .then((response) => {
                ...
                if(vm.api_status_code.SUCCESSFUL_DB_QUERY.MSG_CODE === response.data.message.MSG_CODE) {
                  Swal({
                    type: "success",
                    text: vm.tlt('template_data_added'),
                    timer: 2500,
                  }).then((result) => {
                    vm.empty_variable();
                    vm.load_templates();
                ...
                } else if(vm.api_status_code.UNSUCCESSFUL_DB_QUERY.MSG_CODE === response.data.message.MSG_CODE) {
                  Swal({
                    type: "error",
                    text: vm.tlt('db_operation_unsuccess'),
                    timer: 2500,
                  });
                  return
                } else if(vm.api_status_code.TEMPLATE_DETAILS_MISSING.MSG_CODE === response.data.message.MSG_CODE) {
                  Swal({
                    type: "warning",
                    text: vm.tlt('template_detail_missing'),
                    timer: 2500,
                  });
                  return
                } else {
              ...
              .catch((e) => {
                ...
                if (
                  ...
                  vm.$root.$emit("Session_Expired", e.response.data);
                }
              });
              vm.local_close_modal()
          }
        },100)
      };
    },
    local_close_modal(){
      this.close_modal('save_btn_custom')
    },
  },
};
</script>
