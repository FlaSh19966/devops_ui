                    ...
                    <div class="card-header d-block d-sm-flex flex-wrap justify-content-between">
                        <div style="display: contents;">
                                            ...
                                            <ul class="navbar-nav flex-column">
                                                <li class="nav-item">
                                                    ...
                                                    >
                                                        ...
                                                        <span class="txt" style="display: inline-block;vertical-align: middle;" @click="makeVisible">General</span>
                                                    </a>
                                                    <div
                                                        class="dropdown-menu"
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    >
                                                        ...
                                                        <span class="txt" style="display: inline-block;vertical-align: middle;" @click="makeVisible">Form</span>
                                                    </a>
                                                    <div
                                                        class="dropdown-menu"
                                                        aria-labelledby="navbarDropdown"
                                                ...
                                                <li v-if="bot_type=='Open Bot'" class="nav-item">
                                                    ...
                                                    <div
                                                        ...
                                                        style="width:100%;position:static"
                                                    >
                                                        <div v-for="(taskname, taskid) in TaskList" :key="taskid" :id="'Task'+TaskList[taskid].TaskId" draggable="true" @dragstart="startdrag" class="form-control" :title="taskname.TaskName" style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">
                                                            <svg 
                                                            xmlns="http://www.w3.org/2000/svg" 
                                                            width="13.011" 
                                                            height="13.01" 
                            ...
                            <div class="workflow">
                                ...
                                <div id="addworkflownode" style="width:100%;postion:relative;min-height:90%;background-image: url(/img/sdk-background.png);" >
                                    <div :id="levels[level].id+'outer'" v-for="(level, indextest) in selectedlevellist" :key="indextest">
                                        ...
                                        <div class="level" :id="levels[level].id" @drop="completedrop" @dragover="handledrop">
                                            ...
                                            <div :id="'level'+node.id" v-for="(node, index2) in levels[level].nodes" :key="index2" @click="selectnode(index2,indextest)">
                                                ...
                                                <div style="width:auto;margin:2%;display:flex;padding-left:15px;border-radius: 8px;" class="form-control" v-if="node.nodetype=='Text Box'" :id="node.id" @dblclick="resetpath(index2,indextest)">
                                                    ...
                                                    <div :id="levels[level].id+'inner2'" v-if="selectedlevel!=null&&level==selectedlevel">{{singlevalue[index2]}}</div>
                                                </div>
                                                <div style="width:auto;margin:2%;display:flex;padding-left:15px;border-radius: 8px;" class="form-control" v-if="node.nodetype=='TextArea'" :id="node.id" @dblclick="resetpath(index2,indextest)">
                                                    ...
                                                    <div :id="node.id+'inner2'" v-if="selectedlevel!=null&&level==selectedlevel">{{singlevalue[index2]}}</div>
                                                </div>
                                                <div style="width:auto;margin:2%;display:flex;padding-left:15px;border-radius: 8px;" class="form-control" v-if="node.nodetype=='Hyperlink'" :id="node.id" @dblclick="resetpath(index2,indextest)">
                                                    ...
                                                    <div :id="node.id+'inner1'" v-if="node.hyperlink==null&&singlevalue[index2]==null">{{node.nodetype}}</div>
                                                    <a :id="node.id+'inner2'" v-if="level!=selectedlevel" style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;text-align: center;" :href="node.hyperlink">{{node.hyperlink}}</a>
                                                    <a :id="node.id+'inner2'" v-if="level==selectedlevel" style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;text-align: center;" :href="singlevalue[index2]">{{singlevalue[index2]}}</a>
                                                </div>
                                                ...
                                                <div style="width:auto;margin:2%;display:flex;border-radius: 8px;" class="input-group mb-3"  v-if="level==selectedlevel&&node.nodetype=='Dropdown'">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="basic-addon1" v-html="elementsvgs.dropdown"></span>
                                                    </div>
                                                    <select style="width: 90%;display: flex;padding-left: 15px;" class="form-control" id="select_role_name">
                                                        <div class="input-group-prepend">
                                                ...
                                                <div style="width:auto;margin:2%;display:flex;padding-left:15px" class="form-control" v-if="node.nodetype=='Video'" :id="node.id" @dblclick="resetpath(index2,indextest)">
                                                    ...
                                                    <div v-if="level!=selectedlevel&&node.imageurl==null">{{node.nodetype}}</div>
                                                    <div v-if="level!=selectedlevel&&node.imageurl!=null">{{node.imageurl}}</div>
                                                    <div v-if="level==selectedlevel&&singlevalue[index2]==null">{{node.nodetype}}</div>
                                                    <div v-if="level==selectedlevel&&singlevalue[index2]!=null">{{singlevalue[index2]}}</div>
                                                </div>
                                                ...
                                                <div style="width:auto;margin:2%;padding-left:15px" class="form-control" v-if="node.nodetype=='Form'" :id="node.id" @dblclick="resetpath(index2,indextest)" @drop="formdrop">
                                                    ...
                                                    <div :id="node.id+'innercontent'" style="display:flex;width:100%;margin-top:20px;" v-for="(formfields,fid) in node.formfields" :key="fid">
                                                        ...
                                                        <div style="width:100%;" v-if="formfields.nodetype=='Text Box'">
                                                            ...
                                                            <div class="form-control" v-if="level!=selectedlevel&&formfields.header!=null">{{formfields.header}}</div>
                                                            <div class="form-control" v-if="level!=selectedlevel&&formfields.header==null">Field Name</div>
                                                            <div class="form-control" v-if="level==selectedlevel&&formfildnames[fid]!=null&&formfildnames[fid]!=''">{{formfildnames[fid]}}</div>
                                                            <div class="form-control" v-if="level==selectedlevel&&formfildnames[fid]==null">Field Name</div>
                                                            <div class="form-control" v-if="level==selectedlevel&&formfildnames[fid]==''">Field Name</div>
                                                            <!-- {{formfildnames[fid]}} -->
                                            ...
                                            <div v-for="(taskname, taskid) in levels[level].TaskList" :key="taskid" class="form-control" style="width: auto;margin: 2%;display: flex;padding-left: 15px;">
                                                {{taskname.TaskName}}
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div class="setting">
                                ...
                                <div style="height:90%">
                                    <div v-if="selected!=null" class="tagprops">
                                        ...
                                        Display Message
                                        <input type="text" class="tagname form-control" placeholder="Enter button name" v-model="displaymessage" v-on:keyup="saveval">
                                        ...
                                        <div v-for="(node, elements) in levels[selectedlevel].nodes" :key="elements" style="margin-bottom: inherit;border-top: 1px solid #dee2e6;">
                                            <div v-if="levels[selectedlevel].nodes[elements].nodetype=='Button'">
                                                Button Name
                                                <input type="text" class="tagname form-control" placeholder="Enter button name" v-model="singlevalue[elements]" v-on:keyup="saveval">
                                            </div>
                                            <div v-if="levels[selectedlevel].nodes[elements].nodetype=='Text Box'">
                                                Placeholder
                                                <input type="text" class="tagname form-control" placeholder="Enter display message" v-model="singlevalue[elements]" v-on:keyup="saveval">                                        
                                            </div>
                                            <div v-if="levels[selectedlevel].nodes[elements].nodetype=='TextArea'">
                                                Placeholder
                                                <input type="text" class="tagname form-control" placeholder="Enter display message" v-model="singlevalue[elements]" v-on:keyup="saveval">
                                            </div>
                                            <div v-if="levels[selectedlevel].nodes[elements].nodetype=='Hyperlink'">
                                                Link
                                                <input type="text" class="tagname form-control" placeholder="Enter link" v-model="singlevalue[elements]" v-on:keyup="saveval">    
                                            </div>
                                            ...
                                            <div v-if="levels[selectedlevel].nodes[elements].nodetype=='Check Box'">
                                                ...
                                                <div style="display: flex;margin-top: 5%;" v-for="(checkbox,index) in levels[selectedlevel].nodes[elements].values" :key="index">
                                                    <input style="width: 75%;margin-right: 5%;margin-bottom: 0" type="text" class="tagname form-control" placeholder="Value" v-model="value[index]">
                                            ...
                                            <div v-if="levels[selectedlevel].nodes[elements].nodetype=='Message'">
                                                ...
                                                <input type="text" class="tagname form-control" placeholder="Enter display message" v-model="singlevalue[elements]">
                                            </div>
                                                ...
                                                <div v-for="(field,input) in levels[selectedlevel].nodes[elements].formfields" :key="input">
                                                    ...
                                                    <div v-if="field.nodetype=='Radio Button'">
                                                       ...
                                                       <div style="display: flex;margin-top: 5%;" v-for="(checkbox,index) in field.values" :key="index">
                                                            <input style="width: 75%;margin-right: 5%;margin-bottom: 0" type="text" class="tagname form-control" placeholder="Value" v-model="formvalues[input][index].title">
                                        ...
                                        <div v-if="levels[selectedlevel].TaskList.length>0">
                                            Tasks:
                                        </div>
                                        <div v-for="(tasklist,taskindex) in levels[selectedlevel].TaskList" :key="taskindex" style="padding-bottom: 10px;display: flex;">
                                            <div style="width: 80%;">
                                                {{tasklist.TaskName}}
                                            </div>
                                            <button v-if="value.length!=1" class="save_node_button" style="height: 29px;padding-top: 0px;padding-left: 10px;padding-right: 10px;padding-bottom: 0px;background: #F23D3D;border: solid 1px #F23D3D;" @click="deletetask(selectedlevel,taskindex)">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
                                                    <path
                                                    id="trash-can-outline"
                                                    d="M8.375,3v.778H4V5.333h.875V15.444A1.661,1.661,0,0,0,6.625,17h8.75a1.661,1.661,0,0,0,1.75-1.556V5.333H18V3.778H13.625V3H8.375M6.625,5.333h8.75V15.444H6.625V5.333m1.75,1.556v7h1.75v-7H8.375m3.5,0v7h1.75v-7Z"
...
export default {
            ...
            if(this.$route.params.botdata.bot_name==null||this.$route.params.botdata.bot_type==null){
                ...
                if(this.bot_type=='Open Bot'){
                    axios
                        ...
                        .then(response=>{
                            for(let i=0;i<response.data.TasksList.length;i++){
                                if(response.data.TasksList[i].TaskType=='Email'||response.data.TasksList[i].TaskType=='SMS'){
                                    this.TaskList.push({
                                        TaskName: response.data.TasksList[i].TaskName,
                                        TaskId: response.data.TasksList[i].TaskID,
                                    })
                                }
                            }
                            // console.log(this.TaskList,response.data.TasksList);
                        });
                }
            }
        }
    ...
    methods:{
        ...
        completedrop(ev){
            ...
            ev.preventDefault();
            var data = ev.dataTransfer.getData("text");
            // console.log(data,droplevelindex,this.levels[droplevelindex].nodetype,this.levels[droplevelindex].islastnode);
            // console.log(data.indexOf('Task'));
            if((this.levels[droplevelindex].nodetype==null&&this.levels[droplevelindex].islastnode==false)||(this.levels[droplevelindex].nodetype=='Button'&&data=='Button')||data=='Message'||data=='Video'||data=='Image'||data=='Hyperlink'||data.indexOf('Task')!=-1){
        ...
        createnode(id,i){
            ...
            } else if(id.indexOf('Task')!==-1){
                for(let i=0;i<this.TaskList.length;i++){
                    if(this.TaskList[i].TaskId==id.split("Task")[1]){
                        this.levels[i].TaskList.push({
                            TaskName: this.TaskList[i].TaskName,
        ...
        addformfield(type,id){
            for(let i=0;i<this.levels[id-1].nodes.length;i++){
                if(this.levels[id-1].nodes[i].nodetype=='Form'){
                    // console.log('cfwefbcweuifbuiqwbefuiqbifbw');
                    if(type=='Text_Box'){
                        this.levels[id-1].nodes[i].formfields.push({nodetype:'Text Box',header:null ,placeholder:null });
                    } else if(type=='Dropdown'){
                        this.levels[id-1].nodes[i].formfields.push({nodetype:'Dropdown',header:null ,values:[{title:null,payload:null}] });
                    } else if(type=='Check_Box'){
                        this.levels[id-1].nodes[i].formfields.push({nodetype:'Check Box',header:null ,values:[{title:null,payload:null}] });
                    } else if(type=='Radio_Button'){
                        this.levels[id-1].nodes[i].formfields.push({nodetype:'Radio Button',header:null ,values:[{title:null,payload:null}] });
                    }
                }
            }
            this.setvalues();
        ...
        createlevel(levelindex){
            ...
            this.levels[levelindex].nodes[this.levels[levelindex].nodes.length-1].followinglevelid=this.maxid-1;
        ...
        setvalues(){
            ...
            for(let i=0;i<this.levels[this.selectedlevel].nodes.length;i++){
                ...
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='TextArea'){
                    this.singlevalue.push(this.levels[this.selectedlevel].nodes[i].placeholder);
                }
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='Hyperlink'){
                    this.singlevalue.push(this.levels[this.selectedlevel].nodes[i].hyperlink);
                }
                ...
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='Image'){
                    this.singlevalue.push(this.levels[this.selectedlevel].nodes[i].imageurl);
                }
        ...
        savenodevalue(){
            ...
            for(let i=0;i<this.levels[this.selectedlevel].nodes.length;i++){
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='Button'){
                    if(this.singlevalue[i]!=''){
                        this.levels[this.selectedlevel].nodes[i].name=this.singlevalue[i];
                    } else {
                ...
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='Text Box'){
                    ...
                    if(this.singlevalue[i]!=''){
                        ...
                        toastr.error("Placeholder Field Empty");
                    }
                }
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='TextArea'){
                    if(this.singlevalue[i]!=''){
                ...
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='Hyperlink'){
                    if(this.testhyperlink.test(this.singlevalue[i])){
                        this.levels[this.selectedlevel].nodes[i].hyperlink=this.singlevalue[i];
                    } else if(this.singlevalue[i]==''){
                ...
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='Check Box'){
                    for(let j=0;j<this.levels[this.selectedlevel].nodes[i].values.length;j++){
                        if(this.value.indexOf('')==-1||this.value.indexOf(null)==-1){
                            toastr.error("CheckBox value is empty");
                        } else {
                ...
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='Image'){
                    this.levels[this.selectedlevel].nodes[i].imageurl=this.singlevalue[i];
                }
                if(this.levels[this.selectedlevel].nodes[i].nodetype=='Message'){
                    this.levels[this.selectedlevel].nodes[i].message=this.singlevalue[i];
                }
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    if(this.levels[this.selectedlevel].nodes[this.selectednode].nodetype=='Message'||this.levels[this.selectedlevel].nodes[this.selectednode].nodetype=='Image'||this.levels[this.selectedlevel].nodes[this.selectednode].nodetype=='Video'||this.levels[this.selectedlevel].nodes[this.selectednode].nodetype=='Hyperlink'){
                        ...
                        // }
                        this.selectedlevel=this.selectedlevellist[this.selectedlevellist.length-2];
                        this.selectednode=0;
        ...
        setasleafnode(){
            if(this.isDisabled){
                Swal({
                    type: "error",
                    text: "Constains child level. Levels with child level cannot be last level of a branch.",
                    showConfirmButton: true,
                    timer:3000,
                }).then(result => {
                });
        ...
        deletetask(levelindex,taskindex){
            this.levels[levelindex].TaskList.splice(taskindex,1)
        }
    }
}
</script>
